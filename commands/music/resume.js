...
module.exports = {
name: 'devam',
description: 'Bot şarkıyı devam ettirir.',
...
if(müzik.pause(message)) {
    return message.channel.send(errorEmbed.setDescription(`${message.author} bu sunucuda her hangi bir şarkı duraklatılmamış!`))
   
} else {
    müzik.resume(message)
    await message.react('▶️')
    message.channel.send(başarı.setDescription(`Şarkı Devam Ettiriliyor!`))
}
